...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='低产量数据.xlsx', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--num_layer',type=int,default=5,help="隐藏层层数")
        parser.add_argument('--hidden_size',type=int,default=50,help="隐藏层上神经元个数")
